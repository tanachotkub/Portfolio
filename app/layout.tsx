...
export const metadata: Metadata = {
  ...
  openGraph: { title:"Portfolio", description:"Fullstack Developer Portfolio", type:"website" },
}
      ...
      <body className="bg-white text-slate-800  font-sans">
        ...
        <footer className="bg-slate-900 text-slate-400 py-10">
          <div className="max-w-6xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <p className="text-sm">© {new Date().getFullYear()} Kennys. Built with Next.js &amp; Tailwind CSS.</p>
            <div className="flex gap-4">
              ...
              <a href="mailto:tanachot2004@gmail.com" className="hover:text-white transition-colors" aria-label="Email">
