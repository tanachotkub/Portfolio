    ...
    <main className="pt-16 w-full overflow-x-hidden">
      ...
      <section className="mesh-bg py-12 sm:py-16 md:py-20">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h1 className="font-display font-extrabold text-4xl sm:text-5xl text-slate-900 mb-3 sm:mb-4">
          ...
          <div className="inline-flex items-center gap-2 bg-white border border-slate-200 rounded-full px-4 py-2 mt-4 text-xs sm:text-sm text-slate-500 shadow-sm">
            <svg className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-slate-400 shrink-0" fill="currentColor" viewBox="0 0 24 24">
          ...
          <ScrollReveal>
            {repos.length === 0 ? (
              <div className="text-center py-16 sm:py-20">
                ...
                <h3 className="font-display font-bold text-lg sm:text-xl text-slate-700 mb-2">
                  ไม่พบ Repository
                </h3>
